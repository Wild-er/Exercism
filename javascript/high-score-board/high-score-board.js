...
export function createScoreBoard() {
  const object = {'The Best Ever' : 1e+6}; // initialize with The Best Ever having a 100K score
  return object;
}
 ...
 */
export function normalizeScore(params) { // Run the score through the function.
